...
const xBONDUserInfo = ({ contract, account, web3 }) => {
  ...
  const fetchInfo = async () => {
    try {
      ...
      const redeemable = await contract.methods.getRedeemablePLSX(shareBal).call();
      ...
      console.log("User info fetched:", { shareBalance: shareBal, tokenBalance: tokenBal, redeemable });
    } catch (err) {
