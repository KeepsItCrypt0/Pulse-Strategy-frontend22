...
const AdminPanel = ({ web3, contract, account, chainId }) => {
  ...
  useEffect(() => {
    if (contract && web3 && chainId === 1) fetchMintInfo(); // Only for Ethereum
  ...
  // Only render admin functions for Ethereum (PLSTR)
  if (chainId !== 1) return null;

  return (
    <div className="bg-white bg-opacity rounded-lg p-6 card">
