...
const xBONDIssuePLSTR = ({ web3, contract, account }) => {
...
// Note: getTokenContract and formatNumber need to be imported from web3.js
// Add the following import at the top:
// import { getTokenContract, formatNumber } from "../../web3";
export default xBONDIssuePLSTR;
